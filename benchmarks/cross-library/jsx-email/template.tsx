...
export type JsxMarketingEmailProps = {
  preview?: string;
  headline?: ReactNode;
  intro?: ReactNode;
  ctaHref?: string;
...
export function JsxMarketingEmail(
  props: JsxMarketingEmailProps = {},
): ReactElement {
...
export const createJsxMarketingEmail = (props?: JsxMarketingEmailProps) => (
  <JsxMarketingEmail {...props} />
);
